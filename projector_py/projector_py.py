...
lib = ffi.dlopen(r"E:\test_proj\tomo_cmake\build\projector_py\Debug\projector_py.dll")
...
class Pojector:
    ...
    def get_single_projection(self, angle):
        ...
        return list(data[0: c_out_size[0]])
        
angles = np.arange(180, dtype = np.float32)/180.0*np.pi
size = 50;
...
a = proj.get_single_projection(0)
print(a)